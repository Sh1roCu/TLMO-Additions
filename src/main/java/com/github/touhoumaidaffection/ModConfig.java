...
public class ModConfig {
    ...
    public static final ModConfigSpec.DoubleValue CARRIED_SIDE_OFFSET;
    public static final ModConfigSpec.DoubleValue CARRIED_FORWARD_OFFSET;
    public static final ModConfigSpec.DoubleValue CARRIED_VERTICAL_OFFSET;
