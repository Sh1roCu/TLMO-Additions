...
public class Config {
    ...
    private static class Client {
        ...
        public static void register() {
            NeoForgeConfigRegistry.INSTANCE.register(TLMOAdditions.MODID, ModConfig.Type.CLIENT, SPEC, MaidBeacon.MOD_ID + "-client.toml");
        }
    ...
    private static class Server {
        ...
        public static void register() {
            NeoForgeConfigRegistry.INSTANCE.register(TLMOAdditions.MODID, ModConfig.Type.SERVER, SPEC, MaidBeacon.MOD_ID + "-server.toml");
        }
