...
public interface UIConst {
    ImageData buttonImg = new ImageData(
            new ResourceLocation("minecraft:textures/gui/sprites/container/beacon/button.png"),
    ...
    ImageData disabledImg = new ImageData(
            new ResourceLocation("minecraft:textures/gui/sprites/container/beacon/button_disabled.png"),
            new Rectangle(0, 0, 22, 22),
            22, 22,
            22, 22
    );
